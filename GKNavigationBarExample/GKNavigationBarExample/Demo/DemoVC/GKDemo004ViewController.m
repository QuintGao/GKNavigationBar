...
//    [self addChildVC:[GKTab003ViewController new] title:@"我的" imageName:@"Mine"];
    ...
    UINavigationController *nav0 = [UINavigationController rootVC:[GKTab001ViewController new] transitionScale:NO];
    nav0.gk_openScrollLeftPush = YES;
    
    UINavigationController *nav1 = [UINavigationController rootVC:[GKTab002ViewController new] transitionScale:NO];
    nav1.gk_openScrollLeftPush = YES;
    
    UINavigationController *nav2 = [UINavigationController rootVC:[GKTab003ViewController new] transitionScale:NO];
...
- (void)tabBarController:(UITabBarController *)tabBarController didSelectViewController:(UIViewController *)viewController {
    ...
    self.gk_maxPopDistance = viewController.gk_maxPopDistance;
}
